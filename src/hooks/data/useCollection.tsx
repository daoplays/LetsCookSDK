...
import { bignum_to_num } from "../../utils/common";
...
const useCollection = (props: useCollectionProps) => {
    ...
    const { marketplaceSummary, listedAssets } = useMarketplace({ connection: connection, collectionAddress: collectionMint });
    ...
    const fetchInitialCollectionData = useCallback(async () => {
        ...
        const [collection] = CollectionData.struct.deserialize(collection_data.data);
