 ...
 */
export const useGetBalance = ({ publicKey, connection }: UseGetBalanceProps): BalanceResult => {
    ...
    useEffect(() => {
        ...
        if (subscriptionRef.current === null) {
            subscriptionRef.current = connection.onAccountChange(publicKey, handleAccountChange);
        }
